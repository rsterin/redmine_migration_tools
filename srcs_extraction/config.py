...
\tOR\n\
\tpython3 extract_redmine_data.py " + ITALIC + "--help --api-key=<API_KEY> --url=<URL> --single-file=<SINGLE_OUTPUT_FILE> --multiple-files=<MULTIPLE_OUTPUT_FILE> --endpoint=<ENDPOINT>" + END
